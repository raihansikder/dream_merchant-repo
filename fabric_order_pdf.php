...
*/
$filepath=$scriptpath."/fabric_order_sheet.php?po_id=$po_id&param=view&client_id=$client_id&passcode=12345";
//echo $filepath;
...
foreach($e->find('select') as $temp)
	$temp->outertext = $temp->innertext;

foreach($e->find('option[selected=selected]') as $opt)
	$opt->outertext=$opt->innertext;
...
$pdf_file_name=$company_shortcode."_FabricOrder_".$po_id."_".time().".pdf";
